...
public final class ExceptionUtil
{
    ...
    public static <T extends RuntimeException> void handleException(IRunnable actionCallback,
    ...
    public static <T extends RuntimeException, R> R handleException(ISupplier<R> supplier, Runnable runnable,
